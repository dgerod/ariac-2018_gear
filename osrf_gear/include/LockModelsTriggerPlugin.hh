...
*/
/*
 * Desc: Lock models trigger plugin
 * Author: Deanna Hood
 */
#ifndef _GAZEBO_LOCK_MODELS_TRIGGER_PLUGIN_HH_
#define _GAZEBO_LOCK_MODELS_TRIGGER_PLUGIN_HH_
...
namespace gazebo
{
  ...
  class LockModelsTriggerPluginPrivate;

  /// \brief A plugin for a contact sensor attached to a model disposal unit.
  class GAZEBO_VISIBLE LockModelsTriggerPlugin : public SideContactPlugin
  {
    /// \brief Constructor.
    public: LockModelsTriggerPlugin();

    /// \brief Destructor.
    public: virtual ~LockModelsTriggerPlugin();
    ...
    private: std::unique_ptr<LockModelsTriggerPluginPrivate> dataPtr;
  };
}
#endif
